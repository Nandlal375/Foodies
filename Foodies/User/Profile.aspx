<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Foodies.User.Profile" %>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-according-title mb-4">
                                <div class="d-flex justify-content-start">
                                    <div class="image-container">
                                        <img src="<%=Foodies.Utils.GetImageUrl(imageUrl)%>" alt="Alternate Text" id="imgProfile" style="width: 150px; height: 150px;"/>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-info" id="connectedServices-tab" data-toggle="tab" href="#connectedServices"
                                                role="tab" aria-controls="connectedServices" aria-selected="true">
                                    ...
                                    <div class="tab-content ml-1" id="myTabContect">
                                        ...
                                        <%----Order History Start--%>
                                        <div class="tab-pane show fade" id="connectedServices" role="tabpanel" aria-labelledby="ConnectedServices-tab">
