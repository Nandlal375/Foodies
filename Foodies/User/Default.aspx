  <%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Foodies.User.Default" %>
                            ...
                            <div class="col-md-6">
                                <div class="box ">
                                    <div class="img-box">
                                        ...
                                        <img src="<%# Foodies.Utils.GetImageUrl(Eval("ImageUrl"))%>" alt="">
                                            </a>
                                    </div>
