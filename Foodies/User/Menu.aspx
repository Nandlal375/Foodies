<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Foodies.User.Menu" %>
                        ...
                        <ItemTemplate>
                            <div class="col-sm-6 col-lg-4 all <%# Eval("CategoryName").ToString().ToLower()%>">
                                <div class="box">
                                    <div>
                                        <div class="img-box">
                                            <img src="<%# Foodies.Utils.GetImageUrl(Eval("ImageUrl")) %>" alt="imgproduct" class="img-thumbnail">
                                        </div>
